...
func (r RussianReplier) ReviewStageEnd() string {
	...
	msg += "Теперь вы можете получить комментарии от других участников к своим решениям. "
	msg += "Для этого нажмите сюда: " + r.CmdGetReviewsName()
	msg += "\n"
	msg += "Чуть позже мы проверим ваши решения и комментарии и сообщим вам об этом."
	msg += "\n"
	msg += "Спасибо за участие! Мы будем благодарным вам, если вы отправите свои предложения и конструктивную критику @mathbattle_support"
	return msg
}
